...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "lwip", "port", "esp32", "tcp_isn"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "unity", "unity", "extras", "fixture", "src"),
